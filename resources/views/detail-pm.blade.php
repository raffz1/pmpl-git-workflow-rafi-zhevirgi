...
<head>
    ...
    <title>Project Manager - Path Deck</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col overflow-x-hidden relative">
            ...
            <div class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 rounded-3xl p-8 sm:p-10 shadow-[0_12px_40px_-6px_rgba(37,99,235,0.25)] flex flex-col lg:flex-row items-center gap-10 text-white relative overflow-hidden border-none">
                ...
                <div class="flex-grow max-w-2xl order-2 lg:order-1 relative z-10">
                    ...
                    <p class="text-sm sm:text-base text-blue-50/90 leading-relaxed mb-6 font-medium">
                        Project Manager mengatur jalannya proyek agar selesai tepat waktu dan sesuai target. Mereka bertugas mengoordinasikan tim, timeline, serta kebutuhan proyek. PM juga menjadi penghubung antara tim teknis dan klien atau stakeholder. Karir ini membutuhkan kemampuan komunikasi, leadership, dan manajemen yang baik.
                    </p>
                ...
                <div class="w-full lg:w-[380px] h-60 sm:h-72 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10 group relative cursor-pointer order-1 lg:order-2 flex-shrink-0 z-10">
                    <img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=600&auto=format&fit=crop&q=80" alt="Path Wireframe Mockup" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
        ...
        <section class="mb-14 animate-fade-in-up" style="animation-delay: 100ms;">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200/60 pb-6 mb-10">
                <div class="flex items-center gap-4">
                    ...
                    <!-- Reset Progress Form -->
                    <form action="{{ route('path.pm.reset') }}" method="POST" class="inline">
                        @csrf
                    ...
                    @php
                        $curriculum = [
                            [
                                ...
                                'desc' => 'mempelajari alur dan tahapan proyek.',
                                'side' => 'left',
                            ],
                            [
                                'title' => 'Komunikasi & leadership',
                                'desc' => 'mempelajari koordinasi dan kepemimpinan tim.',
                                'side' => 'right',
                            ],
                            [
                                'title' => 'Agile & Scrum',
                                'desc' => 'mempelajari metode kerja pengembangan modern.',
                                'side' => 'left',
                            ],
                            [
                                'title' => 'Requirement gathering',
                                'desc' => 'mempelajari analisis kebutuhan proyek.',
                                'side' => 'right',
                            ],
                            [
                                'title' => 'Timeline & task management',
                                'desc' => 'mempelajari pengaturan jadwal proyek.',
                                'side' => 'left',
                            ],
                            [
                                'title' => 'Risk management',
                                'desc' => 'mempelajari identifikasi risiko proyek.',
                                'side' => 'right',
                            ],
                            [
                                'title' => 'Product & business understanding',
                                'desc' => 'mempelajari tujuan bisnis produk.',
                                'side' => 'left',
                            ],
                            [
                                'title' => 'Tools PM',
                                'desc' => 'mempelajari penggunaan Jira, Trello, dan Notion.',
                                'side' => 'right',
                            ],
                            [
                                'title' => 'Stakeholder management',
                                'desc' => 'mempelajari komunikasi dengan pihak terkait.',
                                'side' => 'left',
                            ],
                            [
                                'title' => 'QUIZ',
                                            ...
                                            <div class="inner-lift flex items-start gap-4">
                                                <div class="w-12 h-12 rounded-xl bg-blue-50 border border-blue-100/50 flex items-center justify-center font-extrabold text-xs text-blue-600 flex-shrink-0 group-hover:bg-white/20 group-hover:border-white/30 group-hover:text-white transition-colors duration-300">
                                                    ...
                                                    <svg class="w-5 h-5 text-blue-600 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 3L2 7l10 4 10-4-10-4zm0 8v10M2 7v10l10 4 10-4V7" />
                                                    </svg>
                                                </div>
                                                <div class="flex-grow">
                                                    ...
                                                    <div>
                                                        @if($status === 'Active')
                                                            <form action="{{ route('path.pm.complete') }}" method="POST" class="inline">
                                                                @csrf
        ...
        <div id="modal-container" class="bg-white rounded-[28px] max-w-4xl w-full overflow-hidden flex flex-col md:flex-row shadow-[0_24px_60px_-15px_rgba(0,0,0,0.3)] relative transform scale-90 translate-y-8 transition-all duration-500 max-h-[90vh] md:max-h-none overflow-y-auto md:overflow-y-visible">
            ...
            <div class="w-full md:w-[35%] bg-[#f0f4ff] p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden shrink-0">
                ...
                <div class="w-full h-48 md:h-64 rounded-2xl overflow-hidden shadow-md mt-6 relative border border-white z-10">
                    <img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=600&auto=format&fit=crop&q=80" alt="Project Manager Hand Typing" class="w-full h-full object-cover">
            ...
            <div class="w-full md:w-[65%] p-6 sm:p-8 flex flex-col justify-between shrink-0 overflow-y-auto max-h-[60vh] md:max-h-none">
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-600 leading-relaxed font-medium mb-6">
                        Project Manager adalah profesi yang bertanggung jawab mengatur jalannya proyek agar selesai sesuai target. Peran ini mencakup pengelolaan tim, timeline, komunikasi, dan kebutuhan proyek. Project Manager menjadi penghubung antara tim teknis dan stakeholder dalam pengembangan produk. Karir ini cocok bagi yang memiliki kemampuan komunikasi, kepemimpinan, dan manajemen yang baik.
                    </p>
                        ...
                        <div class="border border-slate-200/80 rounded-2xl p-4">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <span class="inline-flex items-center gap-1 px-2 py-1 border border-slate-200 rounded-lg text-[9px] font-bold text-slate-700 bg-white">
                                    <span class="text-blue-500 font-mono text-[9px] font-bold">&lt;&gt;</span> Agiel
                                </span>
                                <span class="inline-flex items-center gap-1 px-2 py-1 border border-slate-200 rounded-lg text-[9px] font-bold text-slate-700 bg-white">
                                    <span class="text-blue-500 font-mono text-[9px] font-bold">&lt;&gt;</span> Scrum
                                </span>
                                <span class="inline-flex items-center gap-1 px-2 py-1 border border-slate-200 rounded-lg text-[9px] font-bold text-slate-700 bg-white">
                                    <span class="text-blue-500 font-mono text-[9px] font-bold">&lt;&gt;</span> Leadership
                                </span>
                                <span class="inline-flex items-center gap-1 px-2 py-1 border border-slate-200 rounded-lg text-[9px] font-bold text-slate-700 bg-white">
                                    <span class="text-blue-500 font-mono text-[9px] font-bold">&lt;&gt;</span> Jira
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="bg-blue-50/20 border border-blue-100/30 rounded-2xl p-5">
                        ...
                        <ul class="space-y-3.5 text-xs text-slate-600 font-medium">
                            <li class="flex items-start gap-2.5">
                                ...
                                <span>Suka mengatur tim dan jalannya proyek.</span>
                            </li>
                            <li class="flex items-start gap-2.5">
                                <svg class="w-4 h-4 text-blue-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            ...
                            <li class="flex items-start gap-2.5">
                                ...
                                <span>Tertarik pada strategi dan pengembangan produk.</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const trailSymbols = ['agile', 'scrum', 'timeline', 'tasks', 'risk', 'jira', 'trello', 'notion', 'budget', 'gantt', 'wbs', 'kpi', 'scope', 'milestone'];
