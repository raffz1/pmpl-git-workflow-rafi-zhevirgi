        ...
        <div class="w-full max-w-[420px] bg-white border border-slate-200 rounded-sm shadow-sm p-8">
            ...
            <form method="POST" action="{{ url('/login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" required autofocus class="block w-full px-3 py-2 bg-slate-50/50 border border-slate-200 rounded text-sm focus:ring-1 focus:ring-blue-600 focus:border-blue-600 focus:bg-white transition-colors outline-none">
                </div>
